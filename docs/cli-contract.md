...
currently exposes only help/version/completion; this document does not claim the planned
commands exist. The [constitution](../.specify/memory/constitution.md) governs enforcement.
